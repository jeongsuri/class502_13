...
public class MemberController extends HttpServlet {
    ...
    private String getMode(HttpServletRequest req) {
        ...
        String mode = urls.length > 0 ? urls[urls.length - 1] : "";  //null값이 들어올수있기때문에 대신에 비어있는문자로 들어가게함.
        return mode;
    }
    ...
    //회원 가입 처리
    private void joinProcess(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
